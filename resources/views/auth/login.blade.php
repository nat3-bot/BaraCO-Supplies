<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                <input id="remember_me" type="checkbox" class="rounded border-white-300 text-indigo-600 shadow-sm focus:ring-indigo-500" name="remember">
    ...
    <div class="text-center" style="margin-top: 3%;">
        <hr class="my-2">
        <span class="text-center font-bold" style="margin: 0 5% 0 4%;">Or</span>
        <div>
            <a href="{{ route('google-auth')}}" 
            class=" text-black ring-1 
            ring-transparent transition hover:text-black/70 focus:outline-none 
